...
iweb.controller('i011', function($scope) {
	$scope.navi=0;

	$scope.i011={
		table:[
			{
				time:'2016-09-01 12:11',
				name:'爱琴海',
				id:'1541212',
				xin:'天秤座',
				pre:['全国商品库 20%','全国商品库 30%'],
				admin:'stark',
				state:0,
				caozuo:['新增商圈','全国物品库比例15%-20%']
			}
		]
	}
  ...
  $scope.$on("RESPONSE_RECEIVED_HANDLER", function(event, jo) {
	...
	var haspolygon=false,polygon,first=true,down=false,index,sx,sy,dx,dy;
